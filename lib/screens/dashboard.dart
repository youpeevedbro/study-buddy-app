...
class _DashboardState extends State<Dashboard> with WidgetsBindingObserver {
  ...
  Widget _buildActionCard({
    ...
    final bg = Color.lerp(accent, Colors.white, 0.75)!;
  ...
  Widget _buildTimerCard(ThemeData theme, int secondsRemaining) {
    const pastel = Color(0xFFE57373);

    final glassBase = pastel.withValues(alpha: 0.25);
    final glassHighlight = pastel.withValues(alpha: 0.40);
    final glassShadow = pastel.withValues(alpha: 0.18);
    final glassBorder = pastel.withValues(alpha: 0.55);
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: [glassHighlight, glassShadow],
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: theme.textTheme.titleLarge?.copyWith(
                        ...
                        // keep your big header look but still theme-based
                        fontSize: 60,
                      ),
                      textAlign: TextAlign.center,
                    ),
